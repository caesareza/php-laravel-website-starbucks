...
<body>
    ...
    <footer>
        <div class="footer-l2">
            ...
            <div class="copyrights">© 2021 Starbucks Coffee Company. All rights reserved.</div>
        </div>
    </footer>
</body>
</html>
